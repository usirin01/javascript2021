...
// let findCheapBook =books
//     .filter((book) => book.price > 18).length
//     console.log(findCheapBook)

// function renderBook () {
//     let bookName = document.querySelector("#booktable");
// }

const print = (pArray) =>{
    let bookInformation = document.querySelector("#tablebody");
    bookInformation.innerHTML = "";
    pArray.map((pBook, index) => {
        bookInformation.innerHTML += `
        <tr>
                <td>${index}</td>
                <td>${pBook.bookTitle}</td>
                <td>${pBook.genre}</td>
                <td>${pBook.price}</td>
                <td>${pBook.amount}</td>
            </tr>
